...
class Filter_nodist(BaseEstimator, TransformerMixin):
    def __init__(self):
        pass
    ...
    def transform(self, DF, y=None):
        ...
        used = ["DAYOFSERVICE","TRIPID", "WEEK_DAY", "PERIOD", "condition", "DIFFTIME", "DWELLTIME","RUNNINGTIME", "STARTEND"]
        return DF_filtered[used]
